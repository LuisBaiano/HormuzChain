...
type Ocorrencia struct {
	...
	VesselID     string      `json:"vessel_id,omitempty"`
	CompanyAddr  string      `json:"company_addr,omitempty"`
	CustoELIS    float64     `json:"custo_elis,omitempty"`
	Status       string      `json:"status,omitempty"` // ABERTA, REIVINDICADA, EM_MISSAO, CONCLUIDA, etc.
}
...
const (
	...
	// HormuzChain blockchain types
	MsgTxBroadcast      TipoMensagemBroker = "TX_BROADCAST"
	MsgBlockProposal    TipoMensagemBroker = "BLOCK_PROPOSAL"
	MsgBlockVote        TipoMensagemBroker = "BLOCK_VOTE"
	MsgBlockCommit      TipoMensagemBroker = "BLOCK_COMMIT"
	MsgChainSync        TipoMensagemBroker = "CHAIN_SYNC"
	MsgChainResponse    TipoMensagemBroker = "CHAIN_RESPONSE"
	MsgVesselRegistered TipoMensagemBroker = "VESSEL_REGISTERED"
	MsgVesselLost       TipoMensagemBroker = "VESSEL_LOST"
...
type MensagemBroker struct {
	...
	// Blockchain / Vessel payloads
	Transaction *Transaction `json:"transaction,omitempty"`
	Block       *Block       `json:"block,omitempty"`
	ChainBlocks []Block      `json:"chain_blocks,omitempty"`
	VesselID    string       `json:"vessel_id,omitempty"`
	CompanyAddr string       `json:"company_addr,omitempty"`
